            ...
            <div className="relative aspect-20/19 w-full overflow-hidden rounded-xl bg-[#F2EAD3]">
                ...
                {dish.isGuestFavorite && (
                    <div className="absolute top-3 left-3 z-10">
                        <div className="backdrop-blur-md bg-white/95 px-3 py-1.5 rounded-full shadow-[0_2px_8px_rgba(0,0,0,0.12)] border border-white/20 transition hover:scale-105">
                            <span className="text-xs font-bold text-[#344F1F] tracking-wide">
                                Student favourite
                            </span>
                        </div>
                    </div>
